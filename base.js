...
function initialize()
{
	...
	document.getElementById('premiumText').innerHTML = translations.premiumText;
	document.getElementById('editorThemesAbout').innerHTML = translations.editorThemesAbout;
	document.getElementById('selectiveEditingAbout').innerHTML = translations.selectiveEditingAbout;
	document.getElementById('smootheningAbout').innerHTML = translations.smootheningAbout;
	document.getElementById('advancedSpotHealingAbout').innerHTML = translations.advancedSpotHealingAbout;
	document.getElementById('replaceEyeAbout').innerHTML = translations.replaceEyeAbout;
	document.getElementById('grabcutMaskingAbout').innerHTML = translations.grabcutMaskingAbout;
	document.getElementById('layersIncompositionAbout').innerHTML = translations.layersIncompositionAbout;
	document.getElementById('collageThemesAbout').innerHTML = translations.collageThemesAbout;
	document.getElementById('creativeCameraEditsAbout').innerHTML = translations.creativeCameraEditsAbout;
	document.getElementById('infinteContentAbout').innerHTML = translations.infinteContentAbout;
	document.getElementById('editorThemesText').innerHTML = translations.editorThemesText;
	document.getElementById('selectiveEditingText').innerHTML = translations.selectiveEditingText;
	document.getElementById('smootheningText').innerHTML = translations.smootheningText;
	document.getElementById('smileText').innerHTML = translations.smileText;
	document.getElementById('advancedSpotHealingText').innerHTML = translations.advancedSpotHealingText;
	document.getElementById('replaceEyeText').innerHTML = translations.replaceEyeText;
	document.getElementById('grabcutMasking').innerHTML = translations.grabcutMasking;
	document.getElementById('layersIncompositionText').innerHTML = translations.layersIncompositionText;
	document.getElementById('collageThemesText').innerHTML = translations.collageThemesText;
	document.getElementById('manyMoreText').innerHTML = translations.manyMoreText;
	document.getElementById('terms').innerHTML = translations.terms;
	document.getElementById('policy').innerHTML = translations.policy;
	document.getElementById('disclaimer').innerHTML = translations.disclaimer;
	document.getElementById('creativeCameraEdits').innerHTML = translations.creativeCameraEdits;
	document.getElementById('infinteContentText').innerHTML = translations.infinteContentText;
	document.getElementById('smileAbout').innerHTML = translations.smileAbout;
	...
	document.getElementById('restore').innerHTML = translations.RestorePurchases;
	...
	promiseTranslation.then(() => {
		...
		if (productInfoList.length == 1){
			...
			if (productInfoList[0].productPeriod === "product_monthly"){
				...
				productflag = 'product_monthly';
				buttonText = translations.UnlockPremium;
				document.getElementById("button-primary").innerHTML = buttonText.bold();
			}
